//--------------------------------------------------------------------------------
// Auto-generated by LiteX (c2fd1e9a) on 2024-03-19 13:34:59
//--------------------------------------------------------------------------------
...
#define CSR_LMS7002M_CONTROL_TX_X1_MODE_OFFSET 17
#define CSR_LMS7002M_CONTROL_TX_X1_MODE_SIZE 1
#define CSR_LMS7002M_CONTROL_RX_X1_MODE_OFFSET 18
#define CSR_LMS7002M_CONTROL_RX_X1_MODE_SIZE 1
#define CSR_LMS7002M_CONTROL_CHANNEL_INHIBIT_OFFSET 19
#define CSR_LMS7002M_CONTROL_CHANNEL_INHIBIT_SIZE 2
...
#define CSR_LMS7002M_TX_PATTERN_CONTROL_IQ_INHIBITED_OFFSET 8
#define CSR_LMS7002M_TX_PATTERN_CONTROL_IQ_INHIBITED_SIZE 2
...
/* analyzer */
#define CSR_ANALYZER_BASE (CSR_BASE + 0xf000L)
#define CSR_ANALYZER_MUX_VALUE_ADDR (CSR_BASE + 0xf000L)
#define CSR_ANALYZER_MUX_VALUE_SIZE 1
#define CSR_ANALYZER_TRIGGER_ENABLE_ADDR (CSR_BASE + 0xf004L)
#define CSR_ANALYZER_TRIGGER_ENABLE_SIZE 1
#define CSR_ANALYZER_TRIGGER_DONE_ADDR (CSR_BASE + 0xf008L)
#define CSR_ANALYZER_TRIGGER_DONE_SIZE 1
#define CSR_ANALYZER_TRIGGER_MEM_WRITE_ADDR (CSR_BASE + 0xf00cL)
#define CSR_ANALYZER_TRIGGER_MEM_WRITE_SIZE 1
#define CSR_ANALYZER_TRIGGER_MEM_MASK_ADDR (CSR_BASE + 0xf010L)
#define CSR_ANALYZER_TRIGGER_MEM_MASK_SIZE 5
#define CSR_ANALYZER_TRIGGER_MEM_VALUE_ADDR (CSR_BASE + 0xf024L)
#define CSR_ANALYZER_TRIGGER_MEM_VALUE_SIZE 5
#define CSR_ANALYZER_TRIGGER_MEM_FULL_ADDR (CSR_BASE + 0xf038L)
#define CSR_ANALYZER_TRIGGER_MEM_FULL_SIZE 1
#define CSR_ANALYZER_SUBSAMPLER_VALUE_ADDR (CSR_BASE + 0xf03cL)
#define CSR_ANALYZER_SUBSAMPLER_VALUE_SIZE 1
#define CSR_ANALYZER_STORAGE_ENABLE_ADDR (CSR_BASE + 0xf040L)
#define CSR_ANALYZER_STORAGE_ENABLE_SIZE 1
#define CSR_ANALYZER_STORAGE_DONE_ADDR (CSR_BASE + 0xf044L)
#define CSR_ANALYZER_STORAGE_DONE_SIZE 1
#define CSR_ANALYZER_STORAGE_LENGTH_ADDR (CSR_BASE + 0xf048L)
#define CSR_ANALYZER_STORAGE_LENGTH_SIZE 1
#define CSR_ANALYZER_STORAGE_OFFSET_ADDR (CSR_BASE + 0xf04cL)
#define CSR_ANALYZER_STORAGE_OFFSET_SIZE 1
#define CSR_ANALYZER_STORAGE_MEM_LEVEL_ADDR (CSR_BASE + 0xf050L)
#define CSR_ANALYZER_STORAGE_MEM_LEVEL_SIZE 1
#define CSR_ANALYZER_STORAGE_MEM_DATA_ADDR (CSR_BASE + 0xf054L)
